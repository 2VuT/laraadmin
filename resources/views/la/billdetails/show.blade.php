...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $billdetail->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("BillDetails", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/billdetails/'.$billdetail->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("BillDetails", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.billdetails.destroy', $billdetail->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/billdetails') }}" data-toggle="tooltip" data-placement="right" title="Back to BillDetails"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'id_bill')
						@la_display($module, 'id_product')
