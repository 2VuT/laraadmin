...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $categoty->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Categoties", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/categoties/'.$categoty->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Categoties", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.categoties.destroy', $categoty->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/categoties') }}" data-toggle="tooltip" data-placement="right" title="Back to Categoties"><i class="fa fa-chevron-left"></i></a></li>
